...
const NewProduct = ({close,setUp,up}) => {
  const [supplier, setListSp] = useState([]);
  const [pic, setPic] = useState()
  const [img, setImg] = useState()
  const [color, setColor] = useState([{id:1,color:'red'},{id:2,color:'blue'}])
  const [rom, setRom] = useState([])
  const { update, setUpdate } = useContext(Appcontext);
  const [price, setPrice] = useState([])
  let pr = { id: 0, color: 1, rom: 1, priceim: 0, pricesel: 0, pid: 0 };
  ...
  const formik = useFormik({
    ...
    onSubmit: async value => {
      ...
      axios
        .post('http://localhost:8080/product/save', { product: value, prices:price }, {
          headers: {
            Authorization:
        ...
        .then(res => {
          ...
          // formik.resetForm(formik.values)
            notify('tc', 2, res.data); setPic();
            setUp(up+1)
          }
          
        })
        .catch(err => {
          notify('tc',3,"Create fail")
        })
    }
  })
  //pic
            ...
            <Col md='12'>
              <Card>
                <Row>
                  <Col md='6'>
                    <CardHeader>
                      <h5 className='title'>Fill product's info</h5>
                    </CardHeader>
                  </Col>
                    ...
                    <Row>
                      ...
                      <Col>
                        ...
                        >
                            ...
                            <Col md='4'>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <option value={Number(2)}>Samsung</option>
                                  <option value={Number(3)}>Sony</option>
                                </Input>
                              </FormGroup>
                            </Col>
                            <Col md='4'>
                            ...
                            <Col md='4'>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <option value={1}>Stop bussiness</option>
                          ...
                          <hr />
                          <Row>
                            <Col className='text-center'><h3>Rom and color</h3></Col>
                          </Row>
                          <Row>
                            <Col>
                              {priceList.map((v, i) => (
                                <Row key={i}>
                                  <Col>
                                    ...
                                    <Input
                                      ...
                                      value={v.size}
                                      onChange={e =>
                                        {changePrice(i, 'rom', e.target.value);setUpdate(update+1)}
                                      }
                                    >
                                      {rom.map((v, i) => (
                                        <option value={v.id}>
                                  ...
                                  <Col>
                                    ...
                                    <Input
                                      ...
                                      value={v.color}
                                      onChange={e =>
                                        {changePrice(i, 'color', e.target.value);setUpdate(update+1)}
                                      }
                                    >
                                      {color.map((v, i) => (
                                  ...
                                  <Col>
                                    ...
                                    <Input
                                      ...
                                      value={v.priceim}
                                      onChange={e =>
                                      { changePrice(i, 'priceim', e.target.value);setUpdate(update+1)}
                                      }
                                    ></Input>
                                  </Col>
                                  <Col>
                                    ...
                                    <Input
                                      ...
                                      value={v.pricesel}
                                      onChange={e =>
                                      {changePrice(i, 'pricesel', e.target.value);setUpdate(update+1)}
                                      }
                                    ></Input>
                                  </Col>
                                  <Col md='1'>
